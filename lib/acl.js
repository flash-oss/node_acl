...
Acl.prototype.userRoles = function (userId, cb) {
    return this.backend.getAsync(this.options.buckets.users, userId).then((r) => (cb ? cb(null, r) : r), cb);
};
...
Acl.prototype.roleUsers = function (roleName, cb) {
    return this.backend.getAsync(this.options.buckets.roles, roleName).then((r) => (cb ? cb(null, r) : r), cb);
};
