...
Acl.prototype.addUserRoles = async function (userId, roles) {
    contract(arguments).params("string|number", "string|array").end();
...
/**
  ...
  @return {Promise} Promise resolved when finished
*/
Acl.prototype.removeUserRoles = async function (userId, roles, cb) {
    contract(arguments)
...
Acl.prototype.isAllowed = async function (userId, resource, permissions) {
    contract(arguments).params("string|number", "string", "string|array").end();
